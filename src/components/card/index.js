...
import { Container, Group, Title, SubTitle, Text, Image, Feature, FeatureTitle, FeatureText, FeatureClose, Content, Meta, Entities, Maturity, Item } from './styles/card'
        ...
        <Feature {...restProps} src={`/images/${category}/${itemFeature.genre}/${itemFeature.slug}/large.jpg`}>
            <Content>
                ...
                <FeatureClose onClick={() => setShowFeature(false)}>
                    <img src="/images/icons/close.png" als="Close" />
                </FeatureClose>
